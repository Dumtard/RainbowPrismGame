...
sceneManager.add.prism(new Prism({ x: 3, y: 3, type: Prism.TYPE.TINT, colour: COLOUR.ORANGE, direction: DIRECTION.W }));
sceneManager.add.prism(new Prism({ x: 4, y: 3, type: Prism.TYPE.TINT, colour: COLOUR.RED, direction: DIRECTION.W }));
